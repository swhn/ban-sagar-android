...
class BanSagarMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        showNotification(title = notification.title, body = notification.body, tag = message.messageId)
    }
    ...
    private fun showNotification(title: String?, body: String?, tag: String?) {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setAutoCancel(true)
            .build()
        getSystemService(NotificationManager::class.java).notify(tag, 0, notification)
    }
